...
public class StringMap {
  ...
  StringNode[] table; // The array of tables. Each table cell is a pointer to the head node of a
                      // linked list.
   ...
   * Returns the reference to the String Node if it is present, otherwise returns
   * null.
   **/
