...
public class RBSTTest {
	...
	public static void main(String[] args) {
		...
		// Insert the array into a RBST. Since the rank is between 1 and n instead of 0
		// and n-1, we need to add 1 to i to get the actual rank.
		RBST T = new RBST();
		for (int i = 0; i < N; i++) {
			T.insertNormal(arr[i], i + 1);
			// T.insert(arr[i], i+1); // Comment insertNormal and uncomment this line once
			// you have implemented insert.
		}
		...
		// Insert a bunch of 100s at 10 random locations, both in the array and the
		// RBST.
		for (int i = 0; i < 10; i++) {
			...
			// T.insert(100, loc+1); // Comment insertNormal and uncomment this line once
			// you have implemented insert.
		}
		...
		for (int i = 0; i < 5; i++) {
			...
			// T.insert(200, 1); // Comment insertNormal and uncomment this line once you
			// have implemented insert.
		}
		...
		for (int i = 0; i < 5; i++) {
			...
			// T.insert(300, T.getSize()+1); // Comment insertNormal and uncomment this line
			// once you have implemented insert.
		}
		...
		/*
		 * // Uncomment this multi-line comment once you have tested insertNormal, and
		 * have completed split.
		 * // Do not attempt to execute these without thoroughly testing either
		 * insertNormal or insert.
		 * // Once you have tested insertNormal, you may comment them again when you are
		 * implementing and testing
		 * // insert. Then after you have thoroughly tested insert, you may uncomment
		 * again.
		 * 
		 * 
